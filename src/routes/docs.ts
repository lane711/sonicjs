...
// Glass template route
docsRoutes.get('/glass-template', async (c) => {
  const glassTemplateHtml = `<!DOCTYPE html>
...
<body class="bg-gradient-to-br from-gray-900 via-purple-900 to-violet-800 min-h-screen">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between items-center py-4">
                    <div class="flex items-center space-x-4">
                        <div class="w-8 h-8 bg-gradient-to-br from-purple-400 to-pink-400 rounded-lg flex items-center justify-center">
                            <svg class="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 20 20">
                                <path d="M3 4a1 1 0 011-1h12a1 1 0 011 1v2a1 1 0 01-1 1H4a1 1 0 01-1-1V4zM3 10a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H4a1 1 0 01-1-1v-6zM14 9a1 1 0 00-1 1v6a1 1 0 001 1h2a1 1 0 001-1v-6a1 1 0 00-1-1h-2z"/>
                            </svg>
                        </div>
                        <h1 class="text-xl font-semibold text-white">Glass Admin</h1>
                    </div>
                    
                    <div class="flex items-center space-x-4">
                        <button class="p-2 text-gray-300 hover:text-white transition-colors rounded-lg hover:bg-white/10">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-6">
                ...
                <div class="lg:col-span-1">
                    <nav class="backdrop-blur-md bg-white/10 rounded-xl border border-white/20 shadow-xl p-6">
                        <div class="space-y-4">
                ...
                <div class="lg:col-span-3">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                        <div class="backdrop-blur-md bg-white/10 rounded-xl border border-white/20 shadow-xl p-6">
                    ...
                    <!-- Data table -->
                    <div class="backdrop-blur-md bg-white/10 rounded-xl border border-white/20 shadow-xl overflow-hidden">
  ...
  return c.html(glassTemplateHtml)
})