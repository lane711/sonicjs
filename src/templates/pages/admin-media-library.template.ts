              ...
              <ul class="space-y-1">
                <li>
                  <a href="/admin/media?folder=all" 
                     class="block px-3 py-2 text-sm rounded-md ${data.currentFolder === 'all' ? 'bg-blue-100 text-blue-700' : 'text-gray-700 hover:bg-gray-100'}">
                ...
                ${data.folders.map(folder => `
                  <li>
                    <a href="/admin/media?folder=${folder.folder}" 
                       class="block px-3 py-2 text-sm rounded-md ${data.currentFolder === folder.folder ? 'bg-blue-100 text-blue-700' : 'text-gray-700 hover:bg-gray-100'}">
              ...
              <ul class="space-y-1">
                <li>
                  <a href="/admin/media?type=all" 
                     class="block px-3 py-2 text-sm rounded-md ${data.currentType === 'all' ? 'bg-blue-100 text-blue-700' : 'text-gray-700 hover:bg-gray-100'}">
                    All Types
                  </a>
                </li>
                ${data.types.map(type => `
                  <li>
                    <a href="/admin/media?type=${type.type}" 
                       class="block px-3 py-2 text-sm rounded-md ${data.currentType === type.type ? 'bg-blue-100 text-blue-700' : 'text-gray-700 hover:bg-gray-100'}">
        ...
        <div class="flex-1">
          ...
          <div class="bg-white rounded-lg shadow-sm p-4 mb-6">
            <div class="flex items-center justify-between">
              ...
              <div class="flex items-center space-x-2">
                <span class="text-sm text-gray-500">${data.files.length} files</span>
                <button 
                  id="select-all-btn"
          ...
          ${data.hasNextPage ? `
            <div class="mt-6 flex justify-center">
              <div class="flex space-x-2">
                ...
                ` : ''}
                <span class="px-3 py-2 text-sm text-gray-700">Page ${data.currentPage}</span>
                <a href="${buildPageUrl(data.currentPage + 1, data.currentFolder, data.currentType)}" 
                   class="px-3 py-2 border border-gray-300 rounded-md text-sm hover:bg-gray-50">
                  Next
                </a>
