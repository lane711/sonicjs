 ...
 *
 * This is a custom bootstrap for the monolith that uses the monolith's
 * collection loader instead of the core package's loader.
 */
export function bootstrapMiddleware() {
  return async (c: Context<{ Bindings: Bindings }>, next: Next) => {
    ...
    try {
      ...
      // 2. Sync collection configurations (using monolith's custom loader)
