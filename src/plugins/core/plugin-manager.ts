...
import { Plugin, PluginManager as IPluginManager, PluginRegistry, PluginConfig, PluginContext, PluginStatus, HookSystem, AuthService, ContentService, MediaService, PluginLogger, HOOKS } from '../types'
...
export class PluginManager implements IPluginManager {
   ...
   */
  private async registerPluginExtensions(plugin: Plugin, context: PluginContext): Promise<void> {
    // Register routes
    if (plugin.routes) {
