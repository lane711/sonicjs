/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: ba1766999c9e55c56e8d121690afcbae)
// Runtime types generated with workerd@1.20251001.0 2022-07-12 
declare namespace Cloudflare {
	interface Env {
		sonicjs: KVNamespace;
		INVALIDATE_USER_SESSIONS: string;
		...
		DISABLED_CACHE: string;
		RESEND_API_KEY: string;
		EMAIL_ENABLED: string;
		EMAIL_FROM: string;
		EMAIL_BASE_URL: string;
		EMAIL_FROM_NAME: string;
		EMAIL_SEND_WELCOME_EMAIL: string;
		ONE_TIME_PASSWORD_CHARACTER_LENGTH: string;
		ONE_TIME_PASSWORD_EXPIRATION_TIME: string;
		ONE_TIME_PASSWORD_EMAIL_SUBJECT: string;
		EMAIL_CONFIRMATION_SUBJECT: string;
		EMAIL_CONFIRMATION_REDIRECT_URL: string;
		AUTO_LOGIN_AFTER_EMAIL_CONFIRMATION: string;
		TESTING_MODE: string;
		D1: D1Database;
	}
}
