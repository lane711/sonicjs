...
import { requireAuth, AuthManager, metricsMiddleware, bootstrapMiddleware } from './chunk-CX4ZU2TA.js';
...
export { MigrationService } from './chunk-FPNED6SE.js';
export { renderFilterBar } from './chunk-XJT6CS6V.js';
...
function createSonicJSApp(config = {}) {
  ...
  app.route("/forms", public_forms_default);
  app.route("/api/forms", public_forms_default);
