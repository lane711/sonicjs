import { api_default, api_media_default, api_system_default, admin_api_default, router, adminCollectionsRoutes, adminSettingsRoutes, admin_content_default, adminMediaRoutes, adminPluginRoutes, adminLogsRoutes, userRoutes, auth_default } from './chunk-SYYG3CIE.js';
...
import { metricsMiddleware, bootstrapMiddleware, requireAuth } from './chunk-O7LMFJMZ.js';
...
import { init_admin_layout_catalyst_template, renderAdminLayoutCatalyst } from './chunk-YHLLVUJC.js';
export { getConfirmationDialogScript, renderAlert, renderConfirmationDialog, renderForm, renderFormField, renderPagination, renderTable } from './chunk-YHLLVUJC.js';
...
import { package_default, getCoreVersion } from './chunk-XZUPYVTP.js';
export { QueryFilterBuilder, SONICJS_VERSION, TemplateRenderer, buildQuery, escapeHtml, getCoreVersion, renderTemplate, sanitizeInput, sanitizeObject, templateRenderer } from './chunk-XZUPYVTP.js';
