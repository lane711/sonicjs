...
var chunk2GLW4PMZ_cjs = require('./chunk-2GLW4PMZ.cjs');
var chunk7FOAMNTI_cjs = require('./chunk-7FOAMNTI.cjs');
var chunkGF3QSKAM_cjs = require('./chunk-GF3QSKAM.cjs');
var chunkILZ3DP4I_cjs = require('./chunk-ILZ3DP4I.cjs');
var chunkCVSD6U24_cjs = require('./chunk-CVSD6U24.cjs');
...
function adminSetupMiddleware() {
  return async (c, next) => {
    ...
    const db = c.env.DB;
    const adminExists = await chunk2GLW4PMZ_cjs.checkAdminUserExists(db);
    if (!adminExists) {
...
function createDatabaseToolsAdminRoutes() {
  ...
  router2.use("*", chunkGF3QSKAM_cjs.requireAuth());
...
function createOTPLoginPlugin() {
  ...
  otpAPI.post("/verify", async (c) => {
    try {
      ...
      const token = await chunkGF3QSKAM_cjs.AuthManager.generateToken(user.id, user.email, user.role);
...
function createMagicLinkAuthPlugin() {
  ...
  magicLinkRoutes.get("/verify", async (c) => {
    try {
      ...
      const jwtToken = await chunkGF3QSKAM_cjs.AuthManager.generateToken(
        user.id,
        user.email,
        user.role
      );
      chunkGF3QSKAM_cjs.AuthManager.setAuthCookie(c, jwtToken);
      await db.prepare(`
...
function createSonicJSApp(config = {}) {
  ...
  app.use("*", chunkGF3QSKAM_cjs.metricsMiddleware());
  app.use("*", chunkGF3QSKAM_cjs.bootstrapMiddleware(config));
  ...
  app.route("/api", chunk2GLW4PMZ_cjs.api_default);
  app.route("/api/media", chunk2GLW4PMZ_cjs.api_media_default);
  app.route("/api/system", chunk2GLW4PMZ_cjs.api_system_default);
  app.route("/admin/api", chunk2GLW4PMZ_cjs.admin_api_default);
  app.route("/admin/dashboard", chunk2GLW4PMZ_cjs.router);
  app.route("/admin/collections", chunk2GLW4PMZ_cjs.adminCollectionsRoutes);
  app.route("/admin/settings", chunk2GLW4PMZ_cjs.adminSettingsRoutes);
  app.route("/admin/database-tools", createDatabaseToolsAdminRoutes());
  app.route("/admin/seed-data", createSeedDataAdminRoutes());
  app.route("/admin/content", chunk2GLW4PMZ_cjs.admin_content_default);
  app.route("/admin/media", chunk2GLW4PMZ_cjs.adminMediaRoutes);
  app.route("/admin/plugins", chunk2GLW4PMZ_cjs.adminPluginRoutes);
  app.route("/admin/logs", chunk2GLW4PMZ_cjs.adminLogsRoutes);
  app.route("/admin", chunk2GLW4PMZ_cjs.userRoutes);
  app.route("/auth", chunk2GLW4PMZ_cjs.auth_default);
  app.route("/", chunk2GLW4PMZ_cjs.test_cleanup_default);
...
Object.defineProperty(exports, "ROUTES_INFO", {
  enumerable: true,
  get: function () { return chunk2GLW4PMZ_cjs.ROUTES_INFO; }
});
Object.defineProperty(exports, "adminApiRoutes", {
  enumerable: true,
  get: function () { return chunk2GLW4PMZ_cjs.admin_api_default; }
});
Object.defineProperty(exports, "adminCheckboxRoutes", {
  enumerable: true,
  get: function () { return chunk2GLW4PMZ_cjs.adminCheckboxRoutes; }
});
Object.defineProperty(exports, "adminCodeExamplesRoutes", {
  enumerable: true,
  get: function () { return chunk2GLW4PMZ_cjs.admin_code_examples_default; }
});
Object.defineProperty(exports, "adminCollectionsRoutes", {
  enumerable: true,
  get: function () { return chunk2GLW4PMZ_cjs.adminCollectionsRoutes; }
});
Object.defineProperty(exports, "adminContentRoutes", {
  enumerable: true,
  get: function () { return chunk2GLW4PMZ_cjs.admin_content_default; }
});
Object.defineProperty(exports, "adminDashboardRoutes", {
  enumerable: true,
  get: function () { return chunk2GLW4PMZ_cjs.router; }
});
Object.defineProperty(exports, "adminDesignRoutes", {
  enumerable: true,
  get: function () { return chunk2GLW4PMZ_cjs.adminDesignRoutes; }
});
Object.defineProperty(exports, "adminLogsRoutes", {
  enumerable: true,
  get: function () { return chunk2GLW4PMZ_cjs.adminLogsRoutes; }
});
Object.defineProperty(exports, "adminMediaRoutes", {
  enumerable: true,
  get: function () { return chunk2GLW4PMZ_cjs.adminMediaRoutes; }
});
Object.defineProperty(exports, "adminPluginRoutes", {
  enumerable: true,
  get: function () { return chunk2GLW4PMZ_cjs.adminPluginRoutes; }
});
Object.defineProperty(exports, "adminSettingsRoutes", {
  enumerable: true,
  get: function () { return chunk2GLW4PMZ_cjs.adminSettingsRoutes; }
});
Object.defineProperty(exports, "adminTestimonialsRoutes", {
  enumerable: true,
  get: function () { return chunk2GLW4PMZ_cjs.admin_testimonials_default; }
});
Object.defineProperty(exports, "adminUsersRoutes", {
  enumerable: true,
  get: function () { return chunk2GLW4PMZ_cjs.userRoutes; }
});
Object.defineProperty(exports, "apiContentCrudRoutes", {
  enumerable: true,
  get: function () { return chunk2GLW4PMZ_cjs.api_content_crud_default; }
});
Object.defineProperty(exports, "apiMediaRoutes", {
  enumerable: true,
  get: function () { return chunk2GLW4PMZ_cjs.api_media_default; }
});
Object.defineProperty(exports, "apiRoutes", {
  enumerable: true,
  get: function () { return chunk2GLW4PMZ_cjs.api_default; }
});
Object.defineProperty(exports, "apiSystemRoutes", {
  enumerable: true,
  get: function () { return chunk2GLW4PMZ_cjs.api_system_default; }
});
Object.defineProperty(exports, "authRoutes", {
  enumerable: true,
  get: function () { return chunk2GLW4PMZ_cjs.auth_default; }
});
...
Object.defineProperty(exports, "AuthManager", {
  enumerable: true,
  get: function () { return chunkGF3QSKAM_cjs.AuthManager; }
});
Object.defineProperty(exports, "PermissionManager", {
  enumerable: true,
  get: function () { return chunkGF3QSKAM_cjs.PermissionManager; }
});
Object.defineProperty(exports, "bootstrapMiddleware", {
  enumerable: true,
  get: function () { return chunkGF3QSKAM_cjs.bootstrapMiddleware; }
});
Object.defineProperty(exports, "cacheHeaders", {
  enumerable: true,
  get: function () { return chunkGF3QSKAM_cjs.cacheHeaders; }
});
Object.defineProperty(exports, "compressionMiddleware", {
  enumerable: true,
  get: function () { return chunkGF3QSKAM_cjs.compressionMiddleware; }
});
Object.defineProperty(exports, "detailedLoggingMiddleware", {
  enumerable: true,
  get: function () { return chunkGF3QSKAM_cjs.detailedLoggingMiddleware; }
});
Object.defineProperty(exports, "getActivePlugins", {
  enumerable: true,
  get: function () { return chunkGF3QSKAM_cjs.getActivePlugins; }
});
Object.defineProperty(exports, "isPluginActive", {
  enumerable: true,
  get: function () { return chunkGF3QSKAM_cjs.isPluginActive; }
});
Object.defineProperty(exports, "logActivity", {
  enumerable: true,
  get: function () { return chunkGF3QSKAM_cjs.logActivity; }
});
Object.defineProperty(exports, "loggingMiddleware", {
  enumerable: true,
  get: function () { return chunkGF3QSKAM_cjs.loggingMiddleware; }
});
Object.defineProperty(exports, "optionalAuth", {
  enumerable: true,
  get: function () { return chunkGF3QSKAM_cjs.optionalAuth; }
});
Object.defineProperty(exports, "performanceLoggingMiddleware", {
  enumerable: true,
  get: function () { return chunkGF3QSKAM_cjs.performanceLoggingMiddleware; }
});
Object.defineProperty(exports, "requireActivePlugin", {
  enumerable: true,
  get: function () { return chunkGF3QSKAM_cjs.requireActivePlugin; }
});
Object.defineProperty(exports, "requireActivePlugins", {
  enumerable: true,
  get: function () { return chunkGF3QSKAM_cjs.requireActivePlugins; }
});
Object.defineProperty(exports, "requireAnyPermission", {
  enumerable: true,
  get: function () { return chunkGF3QSKAM_cjs.requireAnyPermission; }
});
Object.defineProperty(exports, "requireAuth", {
  enumerable: true,
  get: function () { return chunkGF3QSKAM_cjs.requireAuth; }
});
Object.defineProperty(exports, "requirePermission", {
  enumerable: true,
  get: function () { return chunkGF3QSKAM_cjs.requirePermission; }
});
Object.defineProperty(exports, "requireRole", {
  enumerable: true,
  get: function () { return chunkGF3QSKAM_cjs.requireRole; }
});
Object.defineProperty(exports, "securityHeaders", {
  enumerable: true,
  get: function () { return chunkGF3QSKAM_cjs.securityHeaders; }
});
Object.defineProperty(exports, "securityLoggingMiddleware", {
  enumerable: true,
  get: function () { return chunkGF3QSKAM_cjs.securityLoggingMiddleware; }
});
...
Object.defineProperty(exports, "MigrationService", {
  enumerable: true,
  get: function () { return chunkCVSD6U24_cjs.MigrationService; }
});
