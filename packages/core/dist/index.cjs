...
var chunkRQHOGNVN_cjs = require('./chunk-RQHOGNVN.cjs');
var chunk7FOAMNTI_cjs = require('./chunk-7FOAMNTI.cjs');
var chunkG6XBR5DV_cjs = require('./chunk-G6XBR5DV.cjs');
var chunkILZ3DP4I_cjs = require('./chunk-ILZ3DP4I.cjs');
var chunkS3W3GN44_cjs = require('./chunk-S3W3GN44.cjs');
...
function adminSetupMiddleware() {
  return async (c, next) => {
    ...
    const db = c.env.DB;
    const adminExists = await chunkRQHOGNVN_cjs.checkAdminUserExists(db);
    if (!adminExists) {
...
function createDatabaseToolsAdminRoutes() {
  ...
  router2.use("*", chunkG6XBR5DV_cjs.requireAuth());
...
function createEmailPlugin() {
  const builder = chunkRQHOGNVN_cjs.PluginBuilder.create({
    name: "email",
...
function createOTPLoginPlugin() {
  ...
  otpAPI.post("/verify", async (c) => {
    try {
      ...
      const token = await chunkG6XBR5DV_cjs.AuthManager.generateToken(user.id, user.email, user.role);
...
function createMagicLinkAuthPlugin() {
  ...
  magicLinkRoutes.get("/verify", async (c) => {
    try {
      ...
      const jwtToken = await chunkG6XBR5DV_cjs.AuthManager.generateToken(
        user.id,
        user.email,
        user.role
      );
      chunkG6XBR5DV_cjs.AuthManager.setAuthCookie(c, jwtToken);
      await db.prepare(`
...
function createSonicJSApp(config = {}) {
  ...
  const appVersion = config.version || chunkPLNXTCZW_cjs.getCoreVersion();
  const appName = config.name || "SonicJS AI";
  app.use("*", async (c, next) => {
    c.set("appVersion", appVersion);
    await next();
  });
  app.use("*", chunkG6XBR5DV_cjs.metricsMiddleware());
  app.use("*", chunkG6XBR5DV_cjs.bootstrapMiddleware(config));
  ...
  app.route("/api", chunkRQHOGNVN_cjs.api_default);
  app.route("/api/media", chunkRQHOGNVN_cjs.api_media_default);
  app.route("/api/system", chunkRQHOGNVN_cjs.api_system_default);
  app.route("/admin/api", chunkRQHOGNVN_cjs.admin_api_default);
  app.route("/admin/dashboard", chunkRQHOGNVN_cjs.router);
  app.route("/admin/collections", chunkRQHOGNVN_cjs.adminCollectionsRoutes);
  app.route("/admin/settings", chunkRQHOGNVN_cjs.adminSettingsRoutes);
  app.route("/admin/database-tools", createDatabaseToolsAdminRoutes());
  app.route("/admin/seed-data", createSeedDataAdminRoutes());
  app.route("/admin/content", chunkRQHOGNVN_cjs.admin_content_default);
  app.route("/admin/media", chunkRQHOGNVN_cjs.adminMediaRoutes);
  app.route("/admin/plugins", chunkRQHOGNVN_cjs.adminPluginRoutes);
  app.route("/admin/logs", chunkRQHOGNVN_cjs.adminLogsRoutes);
  app.route("/admin", chunkRQHOGNVN_cjs.userRoutes);
  app.route("/auth", chunkRQHOGNVN_cjs.auth_default);
  app.route("/", chunkRQHOGNVN_cjs.test_cleanup_default);
...
// src/index.ts
var VERSION = chunkPLNXTCZW_cjs.package_default.version;

Object.defineProperty(exports, "ROUTES_INFO", {
  enumerable: true,
  get: function () { return chunkRQHOGNVN_cjs.ROUTES_INFO; }
});
Object.defineProperty(exports, "adminApiRoutes", {
  enumerable: true,
  get: function () { return chunkRQHOGNVN_cjs.admin_api_default; }
});
Object.defineProperty(exports, "adminCheckboxRoutes", {
  enumerable: true,
  get: function () { return chunkRQHOGNVN_cjs.adminCheckboxRoutes; }
});
Object.defineProperty(exports, "adminCodeExamplesRoutes", {
  enumerable: true,
  get: function () { return chunkRQHOGNVN_cjs.admin_code_examples_default; }
});
Object.defineProperty(exports, "adminCollectionsRoutes", {
  enumerable: true,
  get: function () { return chunkRQHOGNVN_cjs.adminCollectionsRoutes; }
});
Object.defineProperty(exports, "adminContentRoutes", {
  enumerable: true,
  get: function () { return chunkRQHOGNVN_cjs.admin_content_default; }
});
Object.defineProperty(exports, "adminDashboardRoutes", {
  enumerable: true,
  get: function () { return chunkRQHOGNVN_cjs.router; }
});
Object.defineProperty(exports, "adminDesignRoutes", {
  enumerable: true,
  get: function () { return chunkRQHOGNVN_cjs.adminDesignRoutes; }
});
Object.defineProperty(exports, "adminLogsRoutes", {
  enumerable: true,
  get: function () { return chunkRQHOGNVN_cjs.adminLogsRoutes; }
});
Object.defineProperty(exports, "adminMediaRoutes", {
  enumerable: true,
  get: function () { return chunkRQHOGNVN_cjs.adminMediaRoutes; }
});
Object.defineProperty(exports, "adminPluginRoutes", {
  enumerable: true,
  get: function () { return chunkRQHOGNVN_cjs.adminPluginRoutes; }
});
Object.defineProperty(exports, "adminSettingsRoutes", {
  enumerable: true,
  get: function () { return chunkRQHOGNVN_cjs.adminSettingsRoutes; }
});
Object.defineProperty(exports, "adminTestimonialsRoutes", {
  enumerable: true,
  get: function () { return chunkRQHOGNVN_cjs.admin_testimonials_default; }
});
Object.defineProperty(exports, "adminUsersRoutes", {
  enumerable: true,
  get: function () { return chunkRQHOGNVN_cjs.userRoutes; }
});
Object.defineProperty(exports, "apiContentCrudRoutes", {
  enumerable: true,
  get: function () { return chunkRQHOGNVN_cjs.api_content_crud_default; }
});
Object.defineProperty(exports, "apiMediaRoutes", {
  enumerable: true,
  get: function () { return chunkRQHOGNVN_cjs.api_media_default; }
});
Object.defineProperty(exports, "apiRoutes", {
  enumerable: true,
  get: function () { return chunkRQHOGNVN_cjs.api_default; }
});
Object.defineProperty(exports, "apiSystemRoutes", {
  enumerable: true,
  get: function () { return chunkRQHOGNVN_cjs.api_system_default; }
});
Object.defineProperty(exports, "authRoutes", {
  enumerable: true,
  get: function () { return chunkRQHOGNVN_cjs.auth_default; }
});
...
Object.defineProperty(exports, "AuthManager", {
  enumerable: true,
  get: function () { return chunkG6XBR5DV_cjs.AuthManager; }
});
Object.defineProperty(exports, "PermissionManager", {
  enumerable: true,
  get: function () { return chunkG6XBR5DV_cjs.PermissionManager; }
});
Object.defineProperty(exports, "bootstrapMiddleware", {
  enumerable: true,
  get: function () { return chunkG6XBR5DV_cjs.bootstrapMiddleware; }
});
Object.defineProperty(exports, "cacheHeaders", {
  enumerable: true,
  get: function () { return chunkG6XBR5DV_cjs.cacheHeaders; }
});
Object.defineProperty(exports, "compressionMiddleware", {
  enumerable: true,
  get: function () { return chunkG6XBR5DV_cjs.compressionMiddleware; }
});
Object.defineProperty(exports, "detailedLoggingMiddleware", {
  enumerable: true,
  get: function () { return chunkG6XBR5DV_cjs.detailedLoggingMiddleware; }
});
Object.defineProperty(exports, "getActivePlugins", {
  enumerable: true,
  get: function () { return chunkG6XBR5DV_cjs.getActivePlugins; }
});
Object.defineProperty(exports, "isPluginActive", {
  enumerable: true,
  get: function () { return chunkG6XBR5DV_cjs.isPluginActive; }
});
Object.defineProperty(exports, "logActivity", {
  enumerable: true,
  get: function () { return chunkG6XBR5DV_cjs.logActivity; }
});
Object.defineProperty(exports, "loggingMiddleware", {
  enumerable: true,
  get: function () { return chunkG6XBR5DV_cjs.loggingMiddleware; }
});
Object.defineProperty(exports, "optionalAuth", {
  enumerable: true,
  get: function () { return chunkG6XBR5DV_cjs.optionalAuth; }
});
Object.defineProperty(exports, "performanceLoggingMiddleware", {
  enumerable: true,
  get: function () { return chunkG6XBR5DV_cjs.performanceLoggingMiddleware; }
});
Object.defineProperty(exports, "requireActivePlugin", {
  enumerable: true,
  get: function () { return chunkG6XBR5DV_cjs.requireActivePlugin; }
});
Object.defineProperty(exports, "requireActivePlugins", {
  enumerable: true,
  get: function () { return chunkG6XBR5DV_cjs.requireActivePlugins; }
});
Object.defineProperty(exports, "requireAnyPermission", {
  enumerable: true,
  get: function () { return chunkG6XBR5DV_cjs.requireAnyPermission; }
});
Object.defineProperty(exports, "requireAuth", {
  enumerable: true,
  get: function () { return chunkG6XBR5DV_cjs.requireAuth; }
});
Object.defineProperty(exports, "requirePermission", {
  enumerable: true,
  get: function () { return chunkG6XBR5DV_cjs.requirePermission; }
});
Object.defineProperty(exports, "requireRole", {
  enumerable: true,
  get: function () { return chunkG6XBR5DV_cjs.requireRole; }
});
Object.defineProperty(exports, "securityHeaders", {
  enumerable: true,
  get: function () { return chunkG6XBR5DV_cjs.securityHeaders; }
});
Object.defineProperty(exports, "securityLoggingMiddleware", {
  enumerable: true,
  get: function () { return chunkG6XBR5DV_cjs.securityLoggingMiddleware; }
});
...
Object.defineProperty(exports, "MigrationService", {
  enumerable: true,
  get: function () { return chunkS3W3GN44_cjs.MigrationService; }
});
