import { getCacheService, CACHE_CONFIGS, getLogger, SettingsService } from './chunk-M2YDOOBC.js';
import { requireAuth, isPluginActive, requireRole, AuthManager, logActivity } from './chunk-L7NGKYFB.js';
import { PluginService } from './chunk-LWMMMW43.js';
import { MigrationService } from './chunk-FX4YZT5H.js';
import { init_admin_layout_catalyst_template, renderDesignPage, renderCheckboxPage, renderTestimonialsList, renderCodeExamplesList, renderAlert, renderTable, renderPagination, renderConfirmationDialog, getConfirmationDialogScript, renderAdminLayoutCatalyst, renderAdminLayout, adminLayoutV2, renderForm } from './chunk-5RKQB2JG.js';
import { QueryFilterBuilder, sanitizeInput, getCoreVersion, escapeHtml } from './chunk-GJJ4MNKB.js';
...
adminApiRoutes.get("/migrations/status", async (c) => {
  try {
    const { MigrationService: MigrationService2 } = await import('./migrations-KVXS3LAH.js');
    const db2 = c.env.DB;
...
//# sourceMappingURL=chunk-CA6VRMUU.js.map
//# sourceMappingURL=chunk-CA6VRMUU.js.map