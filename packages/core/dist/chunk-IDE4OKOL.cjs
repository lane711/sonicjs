...
INSERT OR IGNORE INTO forms (
  ...
  'contact',
  json('{"components": [{"label": "Name", "key": "name", "type": "textfield", "input": true, "validate": {"required": true}}, {"label": "Email", "key": "email", "type": "email", "input": true, "validate": {"required": true}}, {"label": "Message", "key": "message", "type": "textarea", "input": true, "validate": {"required": true}}, {"label": "Submit", "key": "submit", "type": "button", "input": true, "action": "submit"}]}'),
  json('{"emailNotifications": true, "notifyEmail": "admin@example.com", "successMessage": "Thank you for contacting us! We will get back to you soon.", "submitButtonText": "Send Message", "requireAuth": false, "allowAnonymous": true}'),
  1,
  1,
  unixepoch() * 1000,
  unixepoch() * 1000
...
//# sourceMappingURL=chunk-IDE4OKOL.cjs.map
//# sourceMappingURL=chunk-IDE4OKOL.cjs.map