...
new chunk6FHNRRJ3_cjs.PluginBuilder({
  name: chunk6FHNRRJ3_cjs.manifest_default.name,
  version: chunk6FHNRRJ3_cjs.manifest_default.version,
  description: chunk6FHNRRJ3_cjs.manifest_default.description,
  author: { name: chunk6FHNRRJ3_cjs.manifest_default.author }
}).metadata({
  description: chunk6FHNRRJ3_cjs.manifest_default.description,
  author: { name: chunk6FHNRRJ3_cjs.manifest_default.author }
}).addService("turnstile", chunk6FHNRRJ3_cjs.TurnstileService).addSingleMiddleware("verifyTurnstile", verifyTurnstile, {
...
//# sourceMappingURL=chunk-MNFY6DWY.cjs.map
//# sourceMappingURL=chunk-MNFY6DWY.cjs.map