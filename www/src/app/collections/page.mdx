  ...
  <div className="flex gap-4">
    ...
    <div>
      ...
      <span className="text-sm text-emerald-800 dark:text-emerald-300">
        ...
        code for production—or use both simultaneously.
      </span>
    </div>
  </div>
</div>
...
<Properties>
  <Property name="reference" type="string">
    Reference to another collection. Use for authors, categories. `collection`
...
<Callout type="info">
  Blocks can include nested arrays/objects for repeatable sub-fields inside a
  block.
</Callout>
...
Use reference fields to link content across collections.

<CodeGroup title="Reference Field">

```typescript
featuredPage: {
  type: 'reference',
  title: 'Featured Page',
  collection: ['pages', 'blog_posts'],
}
```
