...
<div className="not-prose mb-6">
  <div className="rounded-lg border border-zinc-200 dark:border-zinc-800 overflow-hidden">
    ...
    <div className="p-4 space-y-2 text-sm">
      <div className="flex items-start gap-2"><span className="text-emerald-500">▸</span><strong>Create PRs:</strong> Generate well-formatted PRs with proper titles and descriptions</div>
      <div className="flex items-start gap-2"><span className="text-emerald-500">▸</span><strong>Monitor CI/CD:</strong> Watch PR checks in real-time until completion</div>
      <div className="flex items-start gap-2"><span className="text-emerald-500">▸</span><strong>Analyze Failures:</strong> Parse CI logs to identify unit test, build, or E2E failures</div>
      <div className="flex items-start gap-2"><span className="text-emerald-500">▸</span><strong>Auto-Fix:</strong> Automatically fix issues and push updates (up to 3 attempts)</div>
    </div>
  </div>
</div>
