...
function CopyButton({ code }: { code: string }) {
  ...
  return (
    <button
      type="button"
      className={clsx(
        'group/button absolute top-3.5 right-4 overflow-hidden rounded-full py-1 pr-3 pl-2 text-2xs font-medium opacity-100 backdrop-blur-sm transition focus:opacity-100',
        copied
