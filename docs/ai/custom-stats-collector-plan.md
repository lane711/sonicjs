...
┌─────────────────────────────────────────────────────────┐
│              Stats Collector API                         │
│   (stats/ - SonicJS app on Cloudflare Workers)          │
│                                                          │
│   Endpoints:                                             │
...
1. Create `/stats` directory in project root
...
Define collections in `stats/src/db/schema.ts` or via admin UI. SonicJS auto-generates API routes.
...
1. **Create stats app** - Set up SonicJS app in `/stats`
